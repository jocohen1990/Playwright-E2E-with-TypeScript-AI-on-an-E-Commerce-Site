...
test('Item is added the shopping cart', async ({ page }) => {
...
// This test is the same as the previous one, but with steps to make it more readable and easier to debug in case of failure. Also makes reading the report easier, as you can see which step failed.
